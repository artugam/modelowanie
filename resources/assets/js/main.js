...
$('.request').click(function(e) {
    ...
    axios.post('/request', data).then(response => {
        ...
        if (response.data['true']) {
            e.currentTarget.parentElement.innerHTML = "<span class='success'>Jesteście już znajomymi</span>";
        }
        else {
            e.currentTarget.parentElement.innerHTML = "<span class='danger'>Usunięto zaproszenie</span>";
        }
    })
});
